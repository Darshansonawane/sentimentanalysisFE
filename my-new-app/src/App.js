      ...
      <header className="Sentiment Analysis on Smart DigiBook">
        ...
        {loading && !isError && !chartData && (
          <div>
            ...
            <img
              ...
              src="https://i.pinimg.com/originals/52/ad/6a/52ad6a11c1dcb1692ff9e321bd520167.gif"
            />
          </div>
        )}
        {isError && !chartData && (
        ...
        {!loading && chartData && (
          <>
            ...
            />
            <div>Total Positive Count = {chartData?.positiveCnt}</div>
            <div> Total Negative Count = {chartData?.negativeCnt}</div>
            <div>
              {" "}
              Total Reveies are =
              {chartData?.positiveCnt + chartData?.negativeCnt}
            </div>
          </>
        )}
      </header>
